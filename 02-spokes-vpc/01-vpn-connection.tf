...
#VPN para FW1#
##############
resource "aws_vpn_connection" "vpn_spoke_vpc1_vpngw_x_fw01" {
  ...
  tags = {
    Name = "vpn_spoke_vpc1_vpngw_x_fw01"
  }
}
...
#VPN para FW2#
##############
resource "aws_vpn_connection" "vpn_spoke_vpc1_vpngw_x_fw02" {
  ...
  tags = {
    Name = "vpn_spoke_vpc1_vpngw_x_fw02"
  }
}
